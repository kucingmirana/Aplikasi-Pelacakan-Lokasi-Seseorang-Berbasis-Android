...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener,
    ...
    FloatingActionButton floatingActionButtonkn;
    Marker marker;
    MarkerOptions mo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButtonkn = findViewById(R.id.float_kanan);
        ...
        floatingActionButtonkn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String visit_user_id = mAuth.getCurrentUser().getUid();
                Intent intent = new Intent(MapsActivity.this, ProfileActivity.class);
                intent.putExtra("visit_user_id", visit_user_id);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_right,R.anim.awal);
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(myCoordinates, 11));
